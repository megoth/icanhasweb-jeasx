...
export default function () {
    return (
        <BlogPost title="Retten på selvet">
...
<p>For det første, la oss si at teknologien til å klone voksne mennesker er tilgjengelig. Akkurat hvordan den funker er uinteressant, men resultatet er at et menneske blir til to helt identiske legemer. Klonen, det kopierte menneske, er altså et fullvoksent individ, og ikke et resultat av noe vekst-akselerende middel.</p>
